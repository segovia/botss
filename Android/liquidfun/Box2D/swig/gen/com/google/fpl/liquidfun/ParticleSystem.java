...
public class ParticleSystem {
  ...
  public void populateUniqueBodyContacts(int[] contacts) {
    liquidfunJNI.ParticleSystem_populateUniqueBodyContacts(swigCPtr, this, contacts);
  }

  public int getUniqueBodyContactCount(int minParticles) {
    return liquidfunJNI.ParticleSystem_getUniqueBodyContactCount(swigCPtr, this, minParticles);
  }
  ...
  public SWIGTYPE_p_b2ExceptionType isBufCopyValid(int startIndex, int numParticles, int copySize, int bufSize) {
    return new SWIGTYPE_p_b2ExceptionType(liquidfunJNI.ParticleSystem_isBufCopyValid(swigCPtr, this, startIndex, numParticles, copySize, bufSize), true);
  }

  public int getPositionBuffer(int startIndex, int numParticles, java.nio.ByteBuffer outBuf) {
    return liquidfunJNI.ParticleSystem_getPositionBuffer(swigCPtr, this, startIndex, numParticles, outBuf);
  }

  public int getPositionAndVelocityBuffer(int startIndex, int numParticles, java.nio.ByteBuffer outBuf) {
    return liquidfunJNI.ParticleSystem_getPositionAndVelocityBuffer(swigCPtr, this, startIndex, numParticles, outBuf);
  }

  public int getColorBuffer(int startIndex, int numParticles, java.nio.ByteBuffer outBuf) {
    return liquidfunJNI.ParticleSystem_getColorBuffer(swigCPtr, this, startIndex, numParticles, outBuf);
  }

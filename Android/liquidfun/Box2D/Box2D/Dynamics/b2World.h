...
{
public:
	void PopulateBeginContacts(int32 AB[]);
	int32 GetBeginContactsArraySize();
	...
	bool UseGravityCenter() const;
	b2Vec2 GetGravityCenter() const;
	void SetGravityCenter(const b2Vec2 &m_gravityCenter);
...
private:
	...
	bool m_useGravityCenter;
	b2Vec2 m_gravityCenter;
	MyContactListener* myContactListener;
};

inline bool b2World::UseGravityCenter() const
{
	return m_useGravityCenter;
}

inline b2Vec2 b2World::GetGravityCenter() const
{
	return m_gravityCenter;
}

inline void b2World::SetGravityCenter(const b2Vec2 &gravityCenter)
{
	m_useGravityCenter = true;

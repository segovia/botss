...
public:
	...
	b2Vec2* GetPositionAndVelocityBuffer();
	...
	void PopulateUniqueBodyContacts(int32 contacts[]);
	int32 GetUniqueBodyContactCount(int32 minParticles);
...
private:
	...
	UserOverridableBuffer<b2Vec2> m_positionAndVelocityBuffer;
	...
	std::vector<int32> m_uniqueBodyContactBuffer;
...
inline b2Vec2* b2ParticleSystem::GetPositionAndVelocityBuffer()
{
	return m_positionAndVelocityBuffer.data;
}
